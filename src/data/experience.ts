...
export const experienceData: ExperienceProps[] = [
    { image: "https://www.trademaster.com.br/wp-content/uploads/2022/08/branco.png", color: '#9C27B0', company: "", date: "Jul de 2022 - Fev de 2023", jobTitle: "Back-end Developer NodeJs", description: "Uma solução que libera crédito e aumenta o prazo de pagamento do pequeno e médio varejo, por meio de uma plataforma que utiliza tecnologias como inteligência artificial e machine learning" },
